...
/**
 * This Exception class represents client side exceptions.
 */
public class CarbonSecurityClientException extends CarbonSecurityLoginException {
    ...
    public CarbonSecurityClientException(String msg) {
        super(msg);
    }

    public CarbonSecurityClientException(String msg, Throwable cause) {
        super(msg, cause);
    }
