...
public class UsernamePasswordLoginModuleTest {

    private static final Logger log = LoggerFactory.getLogger(UsernamePasswordLoginModuleTest.class);
...
//                    configurationEntries[0] = new AppConfigurationEntry(UsernamePasswordLoginModule.class.getName(),
